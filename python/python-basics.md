...
- [Mini-guia de python](#mini-guia-de-python)
  ...
  - [zip](#zip)
  - [Diccionarions](#diccionarions)
    - [crear](#crear)
    - [agregar clave](#agregar-clave)
  ...
  - [Funciones](#funciones)
    - [Return](#return)
    - [Retunr tupla](#retunr-tupla)
  - [args](#args)
  - [kargs](#kargs)
  - [Ciudadanos de primera clase](#ciudadanos-de-primera-clase)
  - [variables com funciones](#variables-com-funciones)
  - [Funcionaes anidadas](#funcionaes-anidadas)
...
Para que python sea conciente que lo que introduces es texto este debe estar entre comilla simple ('') o comilla dobre ("") [son valores inmutables]
...
en caso de claves repetidas python lo tomara como una variable, usando solo la primera declaracion de la clave, y a su ves el ultimo valor que aparezca en el diccionario

> python permita usar multiples tipos de datos como calves, sin embargo es recomendable usar solo strings, ya que permite una mayor legibilidad
...
- [ in ] para saber si la clave existe
- [ .get ]
- [ .keys ]
- [ .values ]
- [ .items ]
...
es la representacion en python de la ausencia de un valor

## bool

Los valores booleanos en python tienen muñliples representaciones, siendo false los mas estrictos:
...
for each nos permite iterar sobre cada elemento con la opcionde ovtener cada uno de estos valores
...
~~~Python
diccionario = {clave_uno: "valor", clave_dos: "valor"}

for number in diccionario.items():
    print(number)
~~~
...
permite saltar al ciclo siguiente
...
~~~Python
def _nuombre_funcion (parametros_funcion) :
~~~
...
es parecido a un switch y ermite evalar un valor a aprtir de diferentes casos
